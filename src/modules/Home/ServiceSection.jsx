...
import { Sparkles, Stethoscope, Syringe, Clock, DollarSign, Loader2, AlertCircle, Calendar } from "lucide-react";
...
const ServicesSection = () => {
    ...
    const handleReserve = (serviceId) => {
      if (!isAuthenticated) {
        navigate("/login", { state: { from: "/#servicios" } });
        return;
      }
      navigate("/appointments/new", { state: { serviceId } });
    };
